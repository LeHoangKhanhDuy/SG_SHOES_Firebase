class TPlatformException implements Exception {
  ...
  String get message {
    switch (code) {
      case 'INVALID-LOGIN-CREDNETIALS':
      ...
      case 'operation-not-allowed':
        return 'Nhà cung cấp đăng nhập bị tắt cho dự án Firebase của bạn.';
      ...
      case 'invalid-verification-id':
        return 'Mã xác minh không hợp lệ. Vui lòng yêu cầu mã xác minh mới.';
      case 'quota-exceeded':
